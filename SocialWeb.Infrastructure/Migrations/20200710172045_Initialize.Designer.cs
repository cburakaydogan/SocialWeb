...
namespace SocialWeb.Infrastructure.Migrations
{
    ...
    [Migration("20200710172045_Initialize")]
            ...
            modelBuilder.Entity("SocialWeb.Domain.Entities.Concrete.AppUser", b =>
                {
                    ...
                    b.Property<DateTime>("CreateDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 7, 10, 20, 20, 45, 284, DateTimeKind.Local).AddTicks(4926));
            ...
            modelBuilder.Entity("SocialWeb.Domain.Entities.Concrete.Follow", b =>
                {
                    ...
                    b.Property<DateTime>("CreateDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 7, 10, 20, 20, 45, 287, DateTimeKind.Local).AddTicks(1866));
            ...
            modelBuilder.Entity("SocialWeb.Domain.Entities.Concrete.Like", b =>
                {
                    ...
                    b.Property<DateTime>("CreateDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 7, 10, 20, 20, 45, 288, DateTimeKind.Local).AddTicks(5686));
            ...
            modelBuilder.Entity("SocialWeb.Domain.Entities.Concrete.Mention", b =>
                {
                    ...
                    b.Property<DateTime>("CreateDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 7, 10, 20, 20, 45, 267, DateTimeKind.Local).AddTicks(7801));
            ...
            modelBuilder.Entity("SocialWeb.Domain.Entities.Concrete.Share", b =>
                {
                    ...
                    b.Property<DateTime>("CreateDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 7, 10, 20, 20, 45, 289, DateTimeKind.Local).AddTicks(7976));
            ...
            modelBuilder.Entity("SocialWeb.Domain.Entities.Concrete.Tweet", b =>
                {
                    ...
                    b.Property<DateTime>("CreateDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 7, 10, 20, 20, 45, 260, DateTimeKind.Local).AddTicks(5458));
